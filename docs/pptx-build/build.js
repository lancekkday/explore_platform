...
next()
{
  ...
  s.addText([
    ...
    { text: '平台驗收(5 個 pytest)', options: { bold: true, color: C.primary, breakLine: true } },
    { text: '✓ v3 body 落地 lang/locale/channel', options: { fontSize: 10, color: C.greenDark, breakLine: true } },
    { text: '✓ 預設值與舊行為一致', options: { fontSize: 10, color: C.greenDark, breakLine: true } },
    { text: '✓ /api/unified-search forward', options: { fontSize: 10, color: C.greenDark, breakLine: true } },
    { text: '✓ /api/ab-check/start forward', options: { fontSize: 10, color: C.greenDark, breakLine: true } },
    { text: '  test_i18n_channel_plumbing.py', options: { fontFace: FONT_MONO, fontSize: 9, color: C.tertiary, breakLine: true } },
    { text: ' ', options: { breakLine: true } },
    { text: 'Follow-up(未進此 PR)', options: { bold: true, color: C.amberDark, breakLine: true } },
    { text: '· Resume 跨 locale 守門(schema 需加欄位)', options: { fontSize: 9, color: C.amberDark, breakLine: true } },
