...
export default function TierBadge({ it }) {
  ...
  const base = 'inline-flex items-center px-1.5 py-0.5 text-[8.5px] font-black rounded border whitespace-nowrap shadow-sm tracking-[1px] leading-none cursor-help';
